<template>
    <div>
        ...
        <div class="container mx-auto p-6">
            ...
            <button @click="openProductModal()" class="bg-teal-500 text-dark px-4 py-2 rounded mb-4 mr-3">Add Product</button>
        ...
        <div v-else>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-2">
                <div v-for="product in products" :key="product.id" class="border rounded-lg p-4 shadow-lg">
                    ...
                    <button @click="openProductModal(product)" class="bg-yellow-500 text-dark px-4 py-2 rounded mr-2">
                        Edit
                    </button>
        ...
        <div v-if="isModalOpen" @click.self="closeModal"
            ...
            <div class="bg-white p-6 rounded shadow-lg w-1/3">
                ...
                <form @submit.prevent="handleProductSubmit">
                    ...
                    <div class="mb-4">
                        <label for="description" class="block text-sm font-semibold">Product Description</label>
                        <input type="text" id="description" v-model="form.description" class="w-full p-2 border rounded"
