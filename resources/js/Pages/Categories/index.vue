<template>
    <div>
        <Menu></Menu>
        <h1 class="text-center py-4 font-bold text-2xl">Manage Categories</h1>
                ...
                <tbody>
                    <tr v-for="category in categories" :key="category.id">
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            <button class="text-teal-500 hover:text-teal-700" @click="openModal(category)">Edit</button> |
                            <button class="text-red-500 hover:text-red-700" @click="deleteCategory(category.id)">Delete</button>
                        </td>
                    </tr>
                </tbody>
            </table>
